...
%     ConcatenatedFits=[ConcatenatedFits ones(1,IncludedBaseline)*mean(RawSignal(event{i}.StartAndEndPoint(1)-IncludedBaseline:event{i}.StartAndEndPoint(1))-mean(RawSignal(event{i}.StartAndEndPoint(1)-IncludedBaseline:event{i}.StartAndEndPoint(1)))) event{i}.AllLevelFits ones(1,IncludedBaseline)*mean(RawSignal(event{i}.StartAndEndPoint(2)+1:event{i}.StartAndEndPoint(2)+IncludedBaseline)-mean(RawSignal(event{i}.StartAndEndPoint(1)-IncludedBaseline:event{i}.StartAndEndPoint(1))))];
    ConcatenatedEvents=[ConcatenatedEvents; (RawSignal(event{i}.StartAndEndPoint(1)-IncludedBaseline:event{i}.StartAndEndPoint(2)))-mean(RawSignal(event{i}.StartAndEndPoint(1)-IncludedBaseline:event{i}.StartAndEndPoint(1)))];
    ConcatenatedFits=[ConcatenatedFits ones(1,IncludedBaseline)*mean(RawSignal(event{i}.StartAndEndPoint(1)-IncludedBaseline:event{i}.StartAndEndPoint(1))-mean(RawSignal(event{i}.StartAndEndPoint(1)-IncludedBaseline:event{i}.StartAndEndPoint(1)))) event{i}.AllLevelFits ones(1,IncludedBaseline)*mean(RawSignal(event{i}.StartAndEndPoint(2)+1:event{i}.StartAndEndPoint(2))-mean(RawSignal(event{i}.StartAndEndPoint(1)-IncludedBaseline:event{i}.StartAndEndPoint(1))))];

else
  ConcatenatedEvents=[ConcatenatedEvents; (RawSignal(event{i}.StartAndEndPoint(1)-IncludedBaseline:event{i}.StartAndEndPoint(2)))];
  ConcatenatedFits=[ConcatenatedFits ones(1,IncludedBaseline)*mean(RawSignal(event{i}.StartAndEndPoint(1)-IncludedBaseline:event{i}.StartAndEndPoint(1))) event{i}.AllLevelFits ones(1,IncludedBaseline)*mean(RawSignal(event{i}.StartAndEndPoint(2)+1:event{i}.StartAndEndPoint(2)))];  
end
